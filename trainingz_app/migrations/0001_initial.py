# Generated by Django 4.0.3 on 2022-03-29 09:26
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('day_name', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='trainingz_app.dayname')),
            ],
        ),
        migrations.CreateModel(
            name='WorkoutBlock',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.TextField()),
                ('training_days', models.ManyToManyField(to='trainingz_app.trainingday')),
            ],
        ),
        migrations.AddField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('training_day', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='trainingz_app.trainingday')),
            ],
        ),
    ]
